...
I am a highly analytical **Microsoft Certified Data Analyst Associate (PL-300)** with a strong foundation in Computer Science Engineering (B.Tech, 2025). I specialize in transforming raw, massive transactional datasets into high-fidelity business intelligence, optimized models, and interactive dashboard command centers.

### 📈 Core Business Impact Metrics:
* **BFSI Auditing**: Processed **6M+ financial transaction records** using SQL and Scikit-learn to cut money-laundering audit latency by **35%**.
* **Logistics Performance**: Modeled supply network parameters across **100K+ shipping records**, lifting logistics operational visibility by **30%**.
* **Growth Marketing**: Built Cohort Retention Matrices and RFM score aggregations on **100K+ e-commerce orders**, driving a **20% surge in customer repeat-purchase rates**.

---

## 🛠️ Technical Skillset

* **Languages**: Python (Pandas, NumPy, Scikit-learn, Matplotlib, Seaborn), SQL (PostgreSQL, MySQL), Power Query (M), DAX
* **BI & Data Visualization**: Microsoft Power BI, Microsoft Excel, Chart.js, Seaborn
* **Database Management**: DBMS, Star Schema Data Modeling, ETL, Query Optimization
* **Analytical Methods**: Exploratory Data Analysis (EDA), Cohort Analysis, RFM Customer Segmentation, Haversine Geospatial Delta, Safety Stock Calculations
* **Machine Learning**: Anomaly Detection, Predictive Analytics, Unsupervised Clustering, Feature Engineering

---

## 📁 Key Projects

### 🚚 1. Supply Chain Risk Analytics & Network Optimizer
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=rohit-bhowmick2002&show_icons=true&theme=tokyonight&hide_border=true&count_private=true" alt="Rohit's GitHub Stats" width="48%" />
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=rohit-bhowmick2002&layout=compact&theme=tokyonight&hide_border=true" alt="Rohit's Top Languages" width="48%" />
</p>
...
I am actively seeking **Data Analyst**, **Business Intelligence (BI) Analyst**, or **Analytics Engineer** roles. If you have an opportunity or want to talk about transactional data pipelines, let's get in touch!

* 📧 Email: [rohitbhowmick817@gmail.com](mailto:rohitbhowmick817@gmail.com)
